...
const LiquidStaking = () => {
  ...
  const validators = [
    { id: 'validator1', name: 'Ethereum Foundation', apy: '8.5%', fee: '5%', status: 'Active' },
    { id: 'validator2', name: 'Coinbase', apy: '8.2%', fee: '6%', status: 'Active' },
    { id: 'validator3', name: 'Binance', apy: '8.7%', fee: '4.5%', status: 'Active' },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-purple-400 text-sm">≈ $25,847.32</p>
            </div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white">0.75 ETH</p>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm">Unstaking Period</p>
              <p className="text-2xl font-bold text-white">7 Days</p>
              <p className="text-blue-400 text-sm">Next epoch in 2h</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
          <h3 className="text-lg font-semibold text-white mb-4">Stake ETH</h3>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">Available: 5.24 ETH</p>
            </div>
            ...
            <div className="bg-gray-900/30 rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-white font-medium">{stakeAmount || '0.0'} stETH</span>
              </div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
          <h3 className="text-lg font-semibold text-white mb-4">Validator Details</h3>
          ...
          {validators.map((validator) => (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-green-400 text-sm">{validator.status}</span>
              </div>
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="text-gray-400">APY</p>
                  <p className="text-white">{validator.apy}</p>
                </div>
                <div>
                  <p className="text-gray-400">Fee</p>
                  <p className="text-white">{validator.fee}</p>
                </div>
              </div>
            </div>
          ))}
      ...
      {/* Staking Positions */}
      <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
        <h3 className="text-lg font-semibold text-white mb-4">Your Staking Positions</h3>
        
        <div className="space-y-4">
          {[
            { validator: 'Ethereum Foundation', amount: '5.0 ETH', rewards: '0.35 ETH', apy: '8.5%' },
            { validator: 'Coinbase', amount: '7.5 ETH', rewards: '0.40 ETH', apy: '8.2%' },
          ].map((position, index) => (
            <div key={index} className="bg-gray-900/30 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-white font-medium">{position.validator}</p>
