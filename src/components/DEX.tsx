...
const DEX = () => {
    const [fromToken, setFromToken] = useState("TVARA");
                    ...
                    <table className="w-full text-sm">
                        ...
                        <tbody>
                            {[
                                {
                                    type: "Swap",
                                    amount: "1.5 TVARA → 3,101.25 VUSD",
                                    price: "$2,067.50",
                                    time: "2 min ago",
                                    status: "Completed",
                                },
