                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
                                    ...
                                    <p className="text-yellow-300 text-sm mt-2">
                                        ...
                                        signing. Never share your private keys.
                                    </p>
                                </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        type="number"
                                        value={
                                            settings.trading.slippageTolerance
                                        }
                                        onChange={(e) =>
                                            updateSetting(
                                                "trading",
                                ...
                                <div>
                                    ...
                                    <input
                                        type="number"
                                        value={
                                            settings.trading.transactionDeadline
                                        }
                                        onChange={(e) =>
                                            updateSetting(
                                                "trading",
